...
#define SEC_ECC_NISTP256_KEY_LEN 32UL
...
#define SEC_KEYCONTAINER_MAX_LEN (1024UL * 6UL)
...
typedef struct {
    SEC_BYTE p[SEC_DH_3072_LEN]; // Prime p. Big-endian format
    SEC_SIZE pLen;               // Length of p in bytes. Max value is 384.
    SEC_BYTE g[SEC_DH_3072_LEN]; // Base g. Big-endian format
